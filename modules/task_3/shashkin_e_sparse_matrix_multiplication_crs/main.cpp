...
#include <iostream>
#include <vector>
#include "../../modules/task_3/shashkin_e_sparse_matrix_multiplication_crs/sparse_matrix_multiplication_crs.h"

TEST(SparseMatrixMultiplication, throw_when_num_of_rows_or_num_of_cols_is_negative) {
  ASSERT_ANY_THROW(SparseComplexMatrix mat(10, -1));
  ASSERT_ANY_THROW(SparseComplexMatrix mat(-10, 1));
  ASSERT_ANY_THROW(SparseComplexMatrix mat(-10, -10));
}

TEST(SparseMatrixMultiplication, can_convert_regular_matrix_to_crs) {
...
TEST(SparseMatrixMultiplication, can_transpose) {
...
TEST(SparseMatrixMultiplication, can_multimply_square_crs_matrices) {
  int size = 5;
...
TEST(SparseMatrixMultiplication, can_multimply_not_square_crs_matrices_correctly) {
  int rows1 = 10;
  int cols1 = 5;
  int rows2 = 5;
  int cols2 = 12;
